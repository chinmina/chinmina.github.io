...
2. Add a new key to the keyset. The `rotate-keyset` command adds a new key without promoting it to primary — the existing primary key continues to be used for encryption:
