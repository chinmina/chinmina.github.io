...
This project makes use of the Go language and toolchain, `direnv` , and `docker compose` to run the server. Setting these
up is outside of the scope of this document, however note that
